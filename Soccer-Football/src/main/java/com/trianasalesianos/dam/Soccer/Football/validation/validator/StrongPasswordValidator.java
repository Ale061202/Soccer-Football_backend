...
import com.trianasalesianos.dam.Soccer.Football.validation.annotation.StrongPasswordMatch;
import org.passay.*;
...
public class StrongPasswordValidator implements ConstraintValidator<StrongPasswordMatch, String> {
    ...
    @Override
    public void initialize(StrongPasswordMatch constraintAnnotation) {
